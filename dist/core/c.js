 ...
 * @param data
 */
export const seekDataKey = (keys, data) => {
 ...
 * @returns
 */
export const withInsertFrom = (fields, tableName) => {
 ...
 * @returns
 */
export const withInsertData = (fields, list) => {
    var vals = [];
    list.forEach(item => {
        const itemVal = [];
        fields.forEach(key => {
 ...
 * @returns
 */
export const withInsertSql = (fields, tableName, list) => {
 ...
 * @returns
 */
export const codeList = (lists, setAttr) => {
 ...
 * @returns
 */
export const INSERT = (tableName, datas) => {
...
const buildC = (pool) => {
    const C = (spotTable) => {
        ...
        const insert = (datas) => {
            ...
            return promise.then(insertSql => SQLExecute(pool, insertSql));
        };
        return insert;
    };
    return C;
